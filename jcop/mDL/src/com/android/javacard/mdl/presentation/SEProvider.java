...
public class SEProvider {
 ...
 private AEADCipher aesGcmCipher;
  ...
  public short doAesGcmOperation(
    ...
    Util.arrayCopyNonAtomic(outputBuf, (short) 0, outData, outDataStart, len);
    return len;
  }
...
//    System.out.println(sb);
  ...
  public short aesGCMEncryptOneShot(
    ...
    initCipher(key,nonce,nonceStart,nonceLen,authData,authDataStart,
        authDataLen, (short) Cipher.MODE_ENCRYPT);
    if (authDataLen != 0) {
  ...
  public short aesGCMDecryptOneShot(
    ...
    // Create the cipher
    initCipher(key,nonce,nonceStart,nonceLen,authData,authDataStart,
        authDataLen, (short) Cipher.MODE_DECRYPT);
  ...
  public void initCipher(
    ...
    aesGcmCipher.init(aesKey, Cipher.MODE_ENCRYPT, nonce, nonceStart, nonceLen);
