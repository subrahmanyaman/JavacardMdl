...
*/
  ...
  public short startByteString(byte[] lenthBuff, short lenthBuffOff, byte lengthSize) {
    ...
    byte additionalLength = calCborAdditionalLengthBytesFor(lenthBuff, lenthBuffOff, lengthSize);
...
*/
  ...
  /**
   * Check whether there is sufficient space for the increment. The reason to do this is to
   * avoid writing data if there isn't sufficient space. Also exception is cauht by the caller to
